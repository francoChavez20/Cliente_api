...
class vistaModelo
{
    ...
    {
        $palabras_permitidas = ['inicio','peliculas','nueva-peli','editar-pelicula','usuario','nuevo-usuario','editar-usuario','cliente','nuevo-cliente','editar-cliente','token','nuevo-token','editar-token','api-request'];
